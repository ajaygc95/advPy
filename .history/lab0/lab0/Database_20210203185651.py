...
# Write a Temperature class to hold the data, partially listed below (see question 3), in a named tuple. The class should contain a constructor and a Python standard string conversion function to convert a Temperature class object to a string.